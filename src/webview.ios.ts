...
export class AWebView extends AWebViewBase {
    ...
    public registerLocalResource(resourceName: string, path: string) {
        const cls = `AWebView<${this}.ios>.registerLocalResource("${resourceName}", "${path}")`;
    ...
    public unregisterLocalResource(resourceName: string) {
        const cls = `AWebView<${this}.ios>.unregisterLocalResource("${resourceName}")`;
        this.writeTrace(() => cls);
    ...
    public getRegisteredLocalResource(resourceName: string) {
        resourceName = this.fixLocalResourceName(resourceName);
        const cls = `AWebView<${this}.ios>.getRegisteredLocalResource("${resourceName}")`;

        const result = this.nativeWrapper.getRegisteredLocalResourceFromNative(resourceName);
