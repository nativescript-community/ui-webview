declare class CustomNSURLProtocol extends NSURLProtocol implements NSURLConnectionDelegate, NSURLSessionTaskDelegate {
    ...
    URLSessionDidReceiveChallengeCompletionHandler(
        ...
        completionHandler: (p1: NSURLSessionAuthChallengeDisposition, p2: NSURLCredential) => void
    ): void;
    ...
    URLSessionTaskWillBeginDelayedRequestCompletionHandler(
        ...
        completionHandler: (p1: NSURLSessionDelayedRequestDisposition, p2: NSURLRequest) => void
    ): void;
...
declare let NotaWebViewExtVersionNumber: number;

declare let NotaWebViewExtVersionString: interop.Reference<number>;
